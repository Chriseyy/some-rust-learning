...
// Return values in scope::

fn return_scope_example_1() {
...
fn return_scope_example_2() {
    ...
    // if i would call a funcntion like calculate_length(s1) which doesnt reuten a vlues like stinrg len
    // the print would wornk caouse s2 isnt known anymore  
}
...
fn main() {
    ...
    return_scope_example_1();
    return_scope_example_2();
}